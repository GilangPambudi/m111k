...
export default function ContactSection() {
  return (
    <section id="contact" className="py-8 sm:py-12 md:py-16 lg:py-24 bg-white">
      <div className="w-[95%] sm:w-[90%] md:w-5/6 mx-auto px-4">
          ...
          <div className="w-full md:w-1/2 mb-8 md:mb-0">
            <div className="relative rounded-xl overflow-hidden max-w-md mx-auto md:max-w-none">
              <Image
                ...
                width={500}
                height={400}
                className="w-full object-contain rounded-xl h-[300px] sm:h-[400px]"
              />
            </div>
          </div>
          <div className="w-full md:w-1/2 md:pl-8 lg:pl-12">
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-4 mt-4 items-center md:items-start">
              ...
              >
                ...
                <span className="whitespace-nowrap">081325490097 | CS Aning</span>
              </a>
            </div>
          </div>
        </div>
